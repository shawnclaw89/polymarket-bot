...
TEAM_ALIASES = {
    ...
    # NHL
    "bruins":       ["boston", "bruin"],
    "sabres":       ["buffalo", "sabre"],
    "red wings":    ["detroit", "red wing"],
    "panthers_nhl": ["florida", "panthers"],
    "canadiens":    ["montreal", "canadien", "habs"],
    "senators":     ["ottawa", "senator"],
    "maple leafs":  ["toronto", "maple leaf", "leafs"],
    "hurricanes":   ["carolina", "hurricane"],
    "coyotes":      ["arizona", "coyote"],
    "blackhawks":   ["chicago", "blackhawk"],
    "avalanche":    ["colorado", "avalanche", "avs"],
    "stars_nhl":    ["dallas", "stars"],
    "wild":         ["minnesota", "wild"],
    "predators":    ["nashville", "predator", "preds"],
    "blues":        ["st. louis", "blues"],
    "jets":         ["winnipeg", "jet"],
    "ducks":        ["anaheim", "duck"],
    "flames":       ["calgary", "flame"],
    "oilers":       ["edmonton", "oiler"],
    "kings_nhl":    ["los angeles k", "kings"],
    "sharks":       ["san jose", "shark"],
    "kraken":       ["seattle", "kraken"],
    "canucks":      ["vancouver", "canuck"],
    "golden knights": ["vegas", "golden knight", "vgk"],
    "rangers_nhl":  ["new york r", "rangers"],
    "islanders":    ["new york i", "islander"],
    "devils":       ["new jersey", "devil"],
    "flyers":       ["philadelphia", "flyer"],
    "penguins":     ["pittsburgh", "penguin", "pens"],
    "capitals":     ["washington", "capital", "caps"],
    "blue jackets": ["columbus", "blue jacket"],
    "lightning":    ["tampa bay", "lightning", "bolts"],
    "thrashers":    ["atlanta", "thrasher"],
    "canes":        ["carolina", "cane"],
    "mammoth":      ["utah mammoth", "mammoth", "utah"],
